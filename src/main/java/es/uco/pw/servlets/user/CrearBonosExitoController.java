...
/**
 * Controlador que gestiona la funcionalidad de crear bonos con éxito.
 */
public class CrearBonosExitoController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/MVC/Views/user/crearBonosExito.jsp");
