...
/**
 * Controlador que gestiona la funcionalidad de bonos.
 */
public class bonosController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/MVC/Views/user/bonos.jsp");
