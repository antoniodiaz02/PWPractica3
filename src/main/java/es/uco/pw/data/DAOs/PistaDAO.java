...
public class PistaDAO {
     ...
     * @return pista Objeto pistaDTO si se encuentra.
     */
    ...
    public int eliminarPista(String nombre) {
        ...
        if (nombre == null || nombre.isEmpty()) {
        	respuesta = -2;
            return respuesta; // Error: Nombre no proporcionado o vacío
        }
        ...
        try {
            ...
            try (PreparedStatement checkStatement = connection.prepareStatement(checkQuery)) {
                ...
                if (!resultSet.next()) {
                	respuesta = 3;
                    return respuesta; // Error: No existe una pista con este nombre
                }
            }
    ...
    /**
     * Devuelve el identificador de la pista por el nombre.
