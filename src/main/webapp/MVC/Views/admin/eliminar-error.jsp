...
<body>
    <div class="container">
        <div class="message-container">
            ...
            %>
                <p>Hubo un problema al intentar eliminar la pista. Por favor, inténtalo nuevamente.</p>
            <% 
                }
            %>
            <a href="<%= request.getContextPath() %>/adminmenu/eliminarPistas" class="button">Volver a la Eliminación</a>
        </div>
    </div>
</body>
</html>
